...
Go to this URL: [https://snack.expo.dev/@camilasandovals/cartapp](https://snack.expo.dev/@camilasandovals/cartapp)
...
1. Go to [https://platform.openai.com/](https://platform.openai.com/) and login or create an account
2. Inside of settings, add the billing information
3. Create an API key
4. Go to [https://replit.com/](https://replit.com/) and create a Replit account
